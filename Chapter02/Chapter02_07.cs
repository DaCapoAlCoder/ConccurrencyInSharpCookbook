...
namespace Chapter02
{
    public class Chapter02_07 : IChapterAsync
    {
        public Task Run()
        {
            ...
            // Configure await false can prevent continuation on the original context if its not necessary. There's also something
            ...
            // If the CallBoth method is simply awaited here there is no synchronization context and so the default
